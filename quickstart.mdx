---
title: "Quickstart"
description: "Get your AI agent its own email address in two commands. Install the CLI, run openmail setup, and start sending and receiving email in minutes."
icon: rocket
---
