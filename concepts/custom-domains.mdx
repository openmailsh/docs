...
| Scope | Meaning |
|-------|---------|
| **All pods** | Account-wide. Any pod can create inboxes on this domain. This is the default for existing domains. |
| **One pod** | Only inboxes in that pod may use the domain. |
