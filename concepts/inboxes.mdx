...
**Multi-tenant** - One account, many inboxes. Create one inbox per agent and route by `inbox_id`. To isolate tenants with pods and pod-scoped API keys, see the [Multi-tenancy guide](/guides/multi-tenancy).
