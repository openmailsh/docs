---
title: "Sender rules"
description: "Control which senders can reach your inboxes using allow and block lists. OpenMail sender rules filter inbound messages before they trigger webhooks."
icon: shield-check
---
