---
title: "Claude Code"
description: "Give your Claude Code agent a real email address in three steps. Install the OpenMail skill, run setup, and start sending and receiving email right away."
icon: terminal
---
