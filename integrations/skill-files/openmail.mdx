---
title: "SKILL.md"
description: "The openmail skill file is installed by openmail setup. It teaches your AI agent how to create inboxes, send email, and handle inbound replies via API."
icon: file-code
---
