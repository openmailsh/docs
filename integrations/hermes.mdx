...
Setup asks. Either list the addresses (`OPENMAIL_ALLOWED_USERS`), or let OpenMail decide and manage it under **Allow/Block List** in the [console](https://console.openmail.sh/sender-rules) or with the CLI:
