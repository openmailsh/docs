...
All inboxes use `openmail.sh` by default. OpenMail handles SPF, DKIM, and DMARC automatically. Need a custom domain like `agent@yourdomain.com`? See [Custom domains](/concepts/custom-domains) (Developer plan and above).
