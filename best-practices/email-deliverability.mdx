...
<Tip>
  OpenMail handles SPF, DKIM, and DMARC automatically for `openmail.sh` — great for getting started. For high-volume cold outreach, verify your own custom domain (Pro plan and above). See [Custom domains](/concepts/custom-domains).
</Tip>
