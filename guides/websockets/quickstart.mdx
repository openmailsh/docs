---
title: "Quickstart"
description: "Connect to OpenMail's WebSocket endpoint and start receiving inbound email events in real time. Step-by-step guide with authentication and code examples."
icon: rocket
---
