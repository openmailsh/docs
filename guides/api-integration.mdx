...
For developers building AI agents with [OpenClaw](https://openclaw.ai), [LangChain](https://langchain.com), [n8n](https://n8n.io), [Make](https://make.com), [Vercel AI SDK](https://sdk.vercel.ai), or any agent framework. This guide uses OpenClaw as the example—the same pattern (create inbox, inject env vars, route inbound by `inbox_id`) works with other frameworks.
