...
| 403 | `forbidden` | A [scoped key](/api-reference/authentication#key-scopes) reached outside its pod or inbox, or attempted an action its scope doesn't allow — including any `/v1/policy` call |
