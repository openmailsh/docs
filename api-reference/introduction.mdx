---
title: "Introduction"
description: "Complete reference for the OpenMail REST API — create and manage inboxes, send messages, read threads, handle attachments, and configure webhooks."
icon: book
---
