...
Yes, on Pro. Every account gets a €200/mo budget by default, with an email at 80% and 100% of it — adjust the amount (or turn it off) anytime in the [Dashboard](https://console.openmail.sh/settings/billing). Auto-pause, which stops sending, inbox creation, and domain creation for the rest of the billing cycle once you hit your limit, stays off by default so nothing is ever blocked unless you turn it on.
