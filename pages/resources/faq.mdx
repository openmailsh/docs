...
Yes, on Pro. Set an optional monthly budget in the [Dashboard](https://console.openmail.sh/settings/billing) and get an email at 80% and 100% of it. You can also turn on auto-pause, which stops sending, inbox creation, and domain creation for the rest of the billing cycle once you hit your limit — off by default, so nothing changes unless you turn it on.
