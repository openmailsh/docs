...
Yes. Use sender rules to block specific email addresses or entire domains. You can also switch to allowlist mode so only approved senders reach your inboxes. Manage rules from **Settings > Allow/Block List** in the [Dashboard](https://console.openmail.sh). See [Sender rules](/concepts/sender-rules).
